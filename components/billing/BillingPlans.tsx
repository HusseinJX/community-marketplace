...
const TIERS: {
...
}[] = [
  {
    ...
    label: "Free Listing",
    price: "$0",
    tagline: "Be found. Not fully claimed.",
    icon: Search,
    cta: "free",
    features: ["Can be found in search", "Limited presence", "Not claimed", "Upgrade to join the network"],
  },
  {
    plan: "member",
    label: "Member",
    ...
    features: [
      ...
      "Basic AI customer-service agent",
      "Posts & basic event visibility",
  ...
  },
  {
    ...
    features: [
      ...
      "Connect shop / menu / catalog",
      "AI voice calls (metered)",
      "Send collaboration invites",
      "Create & organize events",
      "Invite vendors, artists & orgs",
