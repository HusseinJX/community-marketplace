    ...
    <div className="space-y-10">
      ...
      {!profile && (
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          <p className="text-sm font-medium text-amber-900">Link your business for tailored picks</p>
          <p className="mt-1 text-sm text-amber-700">
            Connect your profile and we&apos;ll highlight the resources that fit your business.
          </p>
          <Link
            href="/vendor/setup"
