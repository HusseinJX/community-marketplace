...
- [ ] **`somarts` has never written a single event** — no last-run date at all, baseline 1. Found the moment the panel showed real numbers. Either its recipe is broken or the site has nothing; decide which and fix or remove.
