    ...
    <div className="flex min-w-0 flex-1 flex-col gap-3">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-full max-w-sm rounded-xl border border-stone-200 bg-white px-3.5 py-2 text-[13px] text-stone-900 placeholder-stone-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200"
        />
      </div>
    </div>
  );
