...
- **It immediately found a dead source:** `somarts` has never written a single event — no last-run date at all, against a baseline of 1. Invisible while the screen was showing fixtures.
