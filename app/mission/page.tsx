...
import { Globe2, Network, Sparkles, Users } from "lucide-react";
      ...
      <section className="mx-auto max-w-4xl space-y-10 px-4 py-16 md:px-8 md:py-24">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-pink-500 to-purple-600 p-8 text-white shadow-lg md:p-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <span className="inline-flex cursor-not-allowed items-center gap-2 rounded-full bg-white/10 px-5 py-2.5 text-sm font-medium text-white/40 ring-1 ring-white/20">
              Travel
            </span>
          </div>
        </div>
