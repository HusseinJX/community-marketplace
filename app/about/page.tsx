...
const SECTIONS: Section[] = [
  {
    ...
    body: "We spotlight the three kinds of neighbors who make a place what it is: small local businesses, artists, and community organizations. Each gets a profile that tells who they are and what they do — so the people behind the neighborhood get seen, not scrolled past.",
    href: "/sf",
