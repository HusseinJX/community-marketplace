// Apple root CAs for StoreKit IAP verification, EMBEDDED as PEM strings.
// Embedded (not read from disk) so the deploy pipeline (tar/Docker COPY/Next
// tracing) can never corrupt or drop them. Public certs from
// https://www.apple.com/certificateauthority/ . AppleRootCA-G3 signs IAP data.

export const APPLE_ROOT_CAS: string[] = [
  // AppleRootCA-G3.pem
  `-----BEGIN CERTIFICATE-----
